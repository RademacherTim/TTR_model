...
program TTR_model
 ...
 !---------------------------------------------------------------------------------------!
 tstps = floor (years * 365.25) * stps_per_day
 ...
 timestep : do t = 1, tstps
   ...
   f_T_air   = f_T (T_air)
   f_T_soil  = f_T (T_soil)
   !write (*, *) C_CO2_air, f_T_air, f_T_soil
